...
public class GUI extends JFrame {
    ...
    class TopPanel extends JPanel{
        ...
        private class simpleGameListener implements ActionListener{
            public void actionPerformed(ActionEvent e) {
                ...
                board = new SimpleGame(board.getRedMoveChoice(), board.getBlueMoveChoice());
        ...
        private class generalGameListener implements ActionListener{
            public void actionPerformed(ActionEvent e) {
                ...
                board = new GeneralGame(board.getRedMoveChoice(), board.getBlueMoveChoice());
                System.out.println(board.getGameMode());
            }
        }
    ...
    class BottomPanel extends JPanel{
        ...
        public static void setTurnText(){
            ...
            if (board.currentGameState == Board.gameState.DRAW){
                currentTurnText.setText("The game is a draw.");
            } else if (board.currentGameState == Board.gameState.BLUE_WON){
                currentTurnText.setText("Blue has won.");
            }else if (board.currentGameState == Board.gameState.RED_WON){
