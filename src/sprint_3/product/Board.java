...
public abstract class Board {
    ...
    protected enum gameState {PLAYING, DRAW, BLUE_WON, RED_WON};
    ...
    public char[][] turnREDBOARD;
    public char[][] turnBlueBoard;
    ...
    public Board() {
        ...
        turnREDBOARD = new char[maxVal][maxVal];
        turnBlueBoard = new char[maxVal][maxVal];
        turnNum = 1;
